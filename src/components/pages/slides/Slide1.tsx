...
const Slide1: React.FunctionComponent<ISlide1> = ({ setYear, setFeature }) => {
    ...
    return <div>
        ...
        <SlideText>
            Gender equality is one of the most prominent problems we have yet to solve.
            In the Sustainable Development Goals initiative, the UN has declared its intention to close the gender gap worldwide by 2030.
            How far is the European Union from achieving this goal?
        </SlideText>
    </div>
}
